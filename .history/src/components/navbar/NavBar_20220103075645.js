...
function NavBar(props) {
    ...
    return <header className='primary-header flex'>
        ...
        <button className='mobile-nav-toggle' aria-controls='primary-navigation' ><span className='sr-only'>Menu</span></button>
        <nav >
            <ul id='primary-navigation' aria-expanded="false" className='primary-navigation flex'>
                <li>
                    <a href=''>
